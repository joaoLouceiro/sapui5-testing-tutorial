...
sap.ui.define([
    ...
    QUnit.test("Should return Success", assert => {
    ...
    QUnit.test("Should return None", assert => {
        priceStateTestCase.call(this, {
            assert: assert,
            price: 103,
            expected: "None"
    ...
    QUnit.test("Should return Warning", assert => {
        priceStateTestCase.call(this, {
            assert: assert,
            price: 500,
            expected: "Warning"
    ...
    QUnit.test("Should return Error", assert => {
        priceStateTestCase.call(this, {
            assert: assert,
            price: 3000,
            expected: "Error"
